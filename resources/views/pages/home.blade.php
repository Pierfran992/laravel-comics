...
@section('content')
        {{-- array contenente le info sui fumetti --}}
<?php
$comics = [
    [
...
?>
    {{-- sezione superiore della home in cui verranno inserite le card --}}
    <div class="container-fluid ms_section_card py-4">
        <div class="container">
            <div class="ms_badges">
        ...
        <div class="container d-flex align-items-stretch flex-wrap">
            ...
            // creo un forech per generare le card con gli elementi contenuti nell'array $comics
                foreach ($comics as $comic) {
                    echo "<div class='ms_card col-2 p-2'>" 
                        . "<div>" . " <img src='" . $comic['thumb'] . "'" .  "alt='" . $comic['title'] ."'>" . "</div>"
                        . "<a href='product' class='mt-3'>". $comic['title'] ."</a>"
                        . "</div>";
                }
            ?>
        </div>
